...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-lg font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 min-h-[44px]',
  {
    variants: {
      variant: {
        ...
        link: 'bg-transparent underline-offset-4 hover:underline text-[var(--color-primary)] focus-visible:ring-[var(--color-primary)] min-h-0'
      },
      size: {
